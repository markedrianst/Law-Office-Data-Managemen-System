...
class Cases extends Model
{
    ...
    public function category()      { return $this->belongsTo(CaseCategory::class); }
    public function client()        { return $this->belongsTo(Client::class); }
    public function assignedLawyer(){ return $this->belongsTo(User::class, 'assigned_lawyer_id'); }
    public function assignedClerk() { return $this->belongsTo(User::class, 'assigned_clerk_id'); }
