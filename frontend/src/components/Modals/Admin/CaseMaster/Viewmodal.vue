        ...
        <div class="px-6 sm:px-8 py-6 overflow-y-auto space-y-6">
          ...
          <div class="rounded-xl border border-indigo-100 bg-indigo-50/40 px-5 py-4">
            ...
            <div class="flex flex-wrap gap-1.5">
              ...
              <span v-if="!caseData.current_stage_id" class="text-xs text-slate-400 italic self-center">No stage assigned yet — click Change Stage to begin.</span>
            </div>
            
            <!-- Change Stage Button -->
            <div class="mt-4 flex justify-end">
              <button @click="$emit('change-stage')" class="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-indigo-700 bg-indigo-100 rounded-lg hover:bg-indigo-200 transition-colors">
...
// Category styling (copied from main component)
const categoryMap = {
